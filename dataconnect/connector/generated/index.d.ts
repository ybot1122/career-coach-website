...
export function meetingsByConsultantId(vars: MeetingsByConsultantIdVariables, options?: ExecuteQueryOptions): QueryPromise<MeetingsByConsultantIdData, MeetingsByConsultantIdVariables>;
export function meetingsByConsultantId(dc: DataConnect, vars: MeetingsByConsultantIdVariables, options?: ExecuteQueryOptions): QueryPromise<MeetingsByConsultantIdData, MeetingsByConsultantIdVariables>;
...
export function allConsultantProfilePicturesAndIds(options?: ExecuteQueryOptions): QueryPromise<AllConsultantProfilePicturesAndIdsData, undefined>;
export function allConsultantProfilePicturesAndIds(dc: DataConnect, options?: ExecuteQueryOptions): QueryPromise<AllConsultantProfilePicturesAndIdsData, undefined>;
...
export function getMeeting(vars: GetMeetingVariables, options?: ExecuteQueryOptions): QueryPromise<GetMeetingData, GetMeetingVariables>;
export function getMeeting(dc: DataConnect, vars: GetMeetingVariables, options?: ExecuteQueryOptions): QueryPromise<GetMeetingData, GetMeetingVariables>;
...
export function updateMeetingStatus(vars: UpdateMeetingStatusVariables): MutationPromise<UpdateMeetingStatusData, UpdateMeetingStatusVariables>;
export function updateMeetingStatus(dc: DataConnect, vars: UpdateMeetingStatusVariables): MutationPromise<UpdateMeetingStatusData, UpdateMeetingStatusVariables>;
...
export function updateMeetingCalendlyScheduleUrl(vars: UpdateMeetingCalendlyScheduleUrlVariables): MutationPromise<UpdateMeetingCalendlyScheduleUrlData, UpdateMeetingCalendlyScheduleUrlVariables>;
export function updateMeetingCalendlyScheduleUrl(dc: DataConnect, vars: UpdateMeetingCalendlyScheduleUrlVariables): MutationPromise<UpdateMeetingCalendlyScheduleUrlData, UpdateMeetingCalendlyScheduleUrlVariables>;
...
export function updateUserProfilePicture(vars: UpdateUserProfilePictureVariables): MutationPromise<UpdateUserProfilePictureData, UpdateUserProfilePictureVariables>;
export function updateUserProfilePicture(dc: DataConnect, vars: UpdateUserProfilePictureVariables): MutationPromise<UpdateUserProfilePictureData, UpdateUserProfilePictureVariables>;
...
export function meetingsForCurrentUser(options?: ExecuteQueryOptions): QueryPromise<MeetingsForCurrentUserData, undefined>;
export function meetingsForCurrentUser(dc: DataConnect, options?: ExecuteQueryOptions): QueryPromise<MeetingsForCurrentUserData, undefined>;
